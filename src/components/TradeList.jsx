...
import { Trash2, Edit2, Image as ImageIcon, Link as LinkIcon, X, ExternalLink, Download, AlertTriangle, ArrowUp, ArrowDown, ArrowUpDown, Tag, TrendingUp } from 'lucide-react'
              ...
              <>
                ...
                <td className="py-3 px-4 text-slate-600">
                  <div className="flex flex-col gap-1">
                    ...
                    {trade.conviction && (
                      <span className={`inline-block px-2 py-0.5 rounded text-xs font-medium w-fit ${
                        trade.conviction === 'A+' ? 'bg-purple-100 text-purple-800' :
